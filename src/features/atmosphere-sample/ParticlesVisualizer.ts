...
import atmosphereSampleFragmentShader from '@/features/atmosphere-sample/shaders/fragment.glsl';
import atmosphereSampleVertexShader from '@/features/atmosphere-sample/shaders/vertex.glsl';
